...
[![npm](https://img.shields.io/npm/v/@xenwave/token-lists)](https://unpkg.com/@xenwave/token-lists@latest/)
...
```typescript
import { TokenList, schema } from '@xenwave/token-lists'
